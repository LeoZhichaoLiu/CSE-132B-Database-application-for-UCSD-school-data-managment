    ...
    <table>
        <tr>
            ...
            if (action != null && action.equals("insert")) {
              ...
              PreparedStatement pstmt = conn.prepareStatement("INSERT INTO participate_club(id, name) VALUES (?, ?)");
            ...
            <%
              ...
              if (action != null && action.equals("update")) {
                  ...
                  PreparedStatement pstmt = conn.prepareStatement(
                      "UPDATE participate_club SET name = ? WHERE unique_id = ?");
            ...
            <%
              ...
              if (action != null && action.equals("delete")) {
                  ...
                  PreparedStatement pstmt = conn.prepareStatement("DELETE FROM participate_club WHERE unique_id = ?");
            ...
            <%
              ...
              ResultSet rs = statement.executeQuery("SELECT * FROM participate_club");
            %>
            ...
            <%-- presentation --%>
              <table>
                  ...
                  <tr>
                      <form action="club_submission.jsp" method="get">
                          ...
                          <%
                   			...
                   			ResultSet rs4 = statement4.executeQuery ("select * from club");
                   			%>
                   			<th>
                   			<select name="name">
                   				<%   while (rs4.next()) {   
                 	...
                 	%>
                  	<th>
                   	...
                   	<%
                   		...
                   		ResultSet rs5 = statement5.executeQuery ("select * from club");
                 	%>
                  	<th>
                  	 		<select name="name">
                   			...
                   			<%   while (rs5.next()) {   
                   				 String club_name = rs5.getString("club_name");
                   			%>
  								<option value="<%= club_name%>"><%= club_name%></option>
  							<%  }  %>
						</select>
