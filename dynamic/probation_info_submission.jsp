        ...
        <tr>
            ...
            <%
              ...
              if (action != null && action.equals("update")) {
                  ...
                  PreparedStatement pstmt = conn.prepareStatement(
                      "UPDATE probation SET probation_start = ?, " +
                      "probation_end = ?, reason = ? WHERE unique_id = ?");

                  pstmt.setString(1, request.getParameter("probation_start"));
                  pstmt.setString(2, request.getParameter("probation_end"));
                  pstmt.setString(3, request.getParameter("reason"));
                  pstmt.setInt(4, Integer.parseInt(request.getParameter("unique_id")));
            ...
            <%
              ...
              if (action != null && action.equals("delete")) {
                  ...
                  PreparedStatement pstmt = conn.prepareStatement(
                    "DELETE FROM probation WHERE unique_id = ?");
              ...
              <table>
                  ...
                  <tr>
                      <form action="probation_info_submission.jsp" method="get">
                          ...
                          <th><input value="" name="probation_start" size="15"></th>
                          <th><input value="" name="probation_end" size="15"></th>
            ...
            <tr>
                <form action="probation_info_submission.jsp" method="get">
                    ...
                    <td><input value="<%= rs.getString("probation_start") %>" name="probation_start"></td>
                    <td><input value="<%= rs.getString("probation_end") %>" name="probation_end"></td>
