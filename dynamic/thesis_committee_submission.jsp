    ...
    <table>
        <tr>
            ...
            if (action != null && action.equals("insert")) {
              ...
              PreparedStatement pstmt = conn.prepareStatement("INSERT INTO thesis_committee(id, name) VALUES (?, ?)");
            ...
            <%
              ...
              if (action != null && action.equals("update")) {
                  ...
                  PreparedStatement pstmt = conn.prepareStatement(
                      "UPDATE thesis_committee SET name = ? WHERE unique_id = ?");
            ...
            <%
              ...
              if (action != null && action.equals("delete")) {
                  ...
                  PreparedStatement pstmt = conn.prepareStatement("DELETE FROM thesis_committee WHERE unique_id = ?");
                  ...
                  <tr>
                      <form action="thesis_committee_submission.jsp" method="get">
                          ...
                          <%
                   			...
                   			ResultSet rs2 = statement2.executeQuery ("select * from graduate");
                   			%>
                   			<th>
                   			<select name="id">
                   				<%   while (rs2.next()) {   
                   			...
                   			<select name="name">
                   				<%   while (rs4.next()) {   
                   					 ...
                   					 String department_name = rs4.getString("department");
                   					 String commit_info = instructor_name + "-" + department_name;          
                   				%>
  									<option value="<%= commit_info%>"><%= commit_info%></option>
  								<%  }  %>
							</select>
                   			</th>
            ...
            <tr>
                <form action="thesis_committee_submission.jsp" method="get">
                    ...
                    <%
                   		...
                   		ResultSet rs3 = statement3.executeQuery ("select * from graduate");
                 	%>
                  	<th>
                  	 		<select name="id">
                   ...
                   <th>
                   		<select name="name">
                   			...
                   			<%   while (rs5.next()) {   
                   				 ...
                   				 String department_name = rs5.getString("department");
              					 String commit_info = instructor_name + "-" + department_name;  
                   			%>
  								<option value="<%= commit_info %>"><%= commit_info %></option>
  							<%  }  %>
