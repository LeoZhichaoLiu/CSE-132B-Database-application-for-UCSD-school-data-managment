        ...
        <tr>
            ...
            if (action != null && action.equals("insert")) {
              ...
              PreparedStatement pstmt = conn.prepareStatement("INSERT INTO category" +
                    "(category_name, course_info, req_units, req_gpa) VALUES (?, ?, ?, ?)");
            ...
            <%
              ...
              if (action != null && action.equals("update")) {
                  ...
                  PreparedStatement pstmt = conn.prepareStatement(
                      "UPDATE category SET category_name = ?, course_info = ?, req_units = ?, req_gpa = ?" +
                      "WHERE unique_id = ?");
            ...
            <%
              ...
              if (action != null && action.equals("delete")) {
                  ...
                  PreparedStatement pstmt = conn.prepareStatement("DELETE FROM category"  +
                                     " WHERE unique_id = ?");
            ...
            <tr>
                <form action="category.jsp" method="get">
                    ...
                    <td><input value="<%= rs.getString("category_name") %>" name="category_name"></td>
                   <th>
